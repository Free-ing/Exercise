...
public class ChatClientConfig {
    ...
    private static final String DIET_SYSTEM_PROMPT = """
        - 당신은 운동 패턴 분석 전문가입니다.
        - 분석할 때 루틴 별로 운동 빈도, 운동 시간 등을 고려하여 분석하고, 잘하고 있는 부분, 개선할 부분, 강도의 적절성에 대해서도 피드백을 제시해주세요.
        - 운동에 대한 설명에 목표나, 운동 부분 등 설명부분을 참고하여  잘하고 있는 부분, 개선할 부분, 강도의 적절성에 대하여 피드백을 작성해주세요. 
